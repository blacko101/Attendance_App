...
class AdminController {
  ...
  // TODO: GET /api/admin/analytics/school
  ...
  // TODO: GET /api/admin/users?role=&status=&search=&page=
  ...
  Future<ManagedUserModel> createUser(ManagedUserModel user) async {
    ...
    // Mock: return user with generated id
  ...
  // TODO: PUT /api/admin/users/:id
  Future<ManagedUserModel> updateUser(ManagedUserModel user) async {
    await Future.delayed(const Duration(milliseconds: 500));
    return user;
  }

  // TODO: PATCH /api/admin/users/:id/status  { status: 'active'|'inactive'|'suspended' }
  Future<void> updateUserStatus(String userId, UserStatus status) async {
    await Future.delayed(const Duration(milliseconds: 400));
    // Mock: no-op
  }

  // TODO: DELETE /api/admin/users/:id (soft delete)
  Future<void> deactivateUser(String userId) async {
    await Future.delayed(const Duration(milliseconds: 400));
  }

  // TODO: POST /api/admin/users/bulk-upload (multipart CSV)
  Future<CsvUploadResult> bulkUploadUsers(
      String csvContent, UserRole role) async {
    ...
    final dataRows = lines.sublist(1); // skip header
    final errors   = <String>[];
    int success    = 0;
    ...
    for (int i = 0; i < dataRows.length; i++) {
      ...
      if (role == UserRole.student && cols.length < 5) {
        errors.add('Row ${i + 2}: expected fullName, email, '
  ...
  Future<List<AdminCourseModel>> fetchCourses({
    ...
    return all.where((c) {
      if (departmentId != null && departmentId.isNotEmpty &&
          c.departmentId != departmentId) return false;
      if (search != null && search.isNotEmpty) {
        final q = search.toLowerCase();
  ...
  // TODO: PATCH /api/admin/courses/:id/assign-lecturer
  //       { lecturerId }
  Future<AdminCourseModel> assignLecturer(
      AdminCourseModel course,
      ManagedUserModel lecturer) async {
    await Future.delayed(const Duration(milliseconds: 400));
  ...
  // TODO: GET /api/admin/timetable?programme=&level=&semester=
  Future<List<TimetableSlotModel>> fetchTimetable({
    ...
    return all.where((s) {
      if (programme != null && programme.isNotEmpty &&
          s.programme != programme) return false;
      if (level != null && level.isNotEmpty &&
          s.level != level) return false;
      return true;
    }).toList();
  }

  // TODO: POST /api/admin/timetable
  Future<TimetableSlotModel> createTimetableSlot(
      TimetableSlotModel slot) async {
    await Future.delayed(const Duration(milliseconds: 500));
  ...
  // TODO: DELETE /api/admin/timetable/:id
  ...
  // TODO: PATCH /api/admin/semesters/:id/set-current
  Future<void> setCurrentSemester(String semesterId) async {
    await Future.delayed(const Duration(milliseconds: 400));
  }

  // ─────────────────────────────────────────────
  //  FETCH HELPERS (used in dropdowns)
  // ─────────────────────────────────────────────
  ...
  List<ManagedUserModel> _mockUsers() => [
    ...
    ManagedUserModel(
      id: 'u8', fullName: 'Prof. Yaw Acheampong',
      email: 'y.acheampong@university.edu.gh',
      role: UserRole.lecturer, status: UserStatus.inactive,
  ...
  List<AdminCourseModel> _mockCourses() => [
    AdminCourseModel(
      id: 'c1', courseCode: 'CS 101',
      courseName:    'Introduction to Computing',
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 120,
    ...
    AdminCourseModel(
      ...
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 60,
      semester:      '2025/2026 Semester 2',
      assignedLecturerId:   'u5',
      assignedLecturerName: 'Dr. Kwame Asante',
    ),
    AdminCourseModel(
      id: 'c3', courseCode: 'CS 301',
      courseName:    'Data Structures & Algorithms',
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 45,
      semester:      '2025/2026 Semester 2',
      assignedLecturerId:   'u5',
      assignedLecturerName: 'Dr. Kwame Asante',
    ),
    AdminCourseModel(
      id: 'c4', courseCode: 'CS 302',
      courseName:    'Database Systems',
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 55,
      semester:      '2025/2026 Semester 2',
      assignedLecturerId:   'u7',
      assignedLecturerName: 'Dr. Kofi Darko',
    ),
    AdminCourseModel(
      id: 'c5', courseCode: 'CS 401',
      courseName:    'Software Engineering',
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 38,
      semester:      '2025/2026 Semester 2',
      assignedLecturerId:   'u5',
      assignedLecturerName: 'Dr. Kwame Asante',
    ),
    AdminCourseModel(
      id: 'c6', courseCode: 'CS 402',
      courseName:    'Artificial Intelligence',
      departmentId:  'dept_cs',
      departmentName:'Computer Science & Engineering',
      creditHours:   3, enrolledStudents: 42,
      semester:      '2025/2026 Semester 2',
    ),
    AdminCourseModel(
      id: 'c7', courseCode: 'EE 201',
      courseName:    'Circuit Theory',
      departmentId:  'dept_elec',
      departmentName:'Electrical Engineering',
      creditHours:   3, enrolledStudents: 78,
      semester:      '2025/2026 Semester 2',
    ),
  ];
  ...
  List<TimetableSlotModel> _mockTimetable() => [
    ...
    TimetableSlotModel(
      id: 't3', courseId: 'c2', courseCode: 'CS 201',
      courseName:   'Object Oriented Programming',
      lecturerName: 'Dr. Kwame Asante',
      day:       TimetableDay.mon,
      startTime: '10:00 AM', endTime: '11:30 AM',
      room: 'ICT Block - Room 3',
      level: '200', programme: 'BSc. Computer Science',
      semester: '2025/2026 Semester 2',
    ),
    TimetableSlotModel(
      id: 't4', courseId: 'c2', courseCode: 'CS 201',
      courseName:   'Object Oriented Programming',
      lecturerName: 'Dr. Kwame Asante',
      day:       TimetableDay.wed,
      startTime: '10:00 AM', endTime: '11:30 AM',
    ...
    TimetableSlotModel(
      id: 't5', courseId: 'c3', courseCode: 'CS 301',
      courseName:   'Data Structures & Algorithms',
      lecturerName: 'Dr. Kwame Asante',
      day:       TimetableDay.tue,
      startTime: '10:00 AM', endTime: '11:30 AM',
      room: 'ICT Block - Lab 1',
      level: '300', programme: 'BSc. Computer Science',
      semester: '2025/2026 Semester 2',
    ),
    TimetableSlotModel(
      id: 't6', courseId: 'c3', courseCode: 'CS 301',
      courseName:   'Data Structures & Algorithms',
      lecturerName: 'Dr. Kwame Asante',
    ...
    TimetableSlotModel(
      id: 't7', courseId: 'c5', courseCode: 'CS 401',
      courseName:   'Software Engineering',
      lecturerName: 'Dr. Kwame Asante',
      day:       TimetableDay.thu,
      startTime: '2:00 PM', endTime: '3:30 PM',
      room: 'Block A - Room 7',
      level: '400', programme: 'BSc. Computer Science',
      semester: '2025/2026 Semester 2',
    ),
  ];
}