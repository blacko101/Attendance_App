...
extension UserRoleExt on UserRole {
  ...
  Color get color {
    switch (this) {
      case UserRole.student:  return const Color(0xFF2196F3);
      case UserRole.lecturer: return const Color(0xFF9B1B42);
      case UserRole.dean:     return const Color(0xFF9C27B0);
      case UserRole.admin:    return const Color(0xFFFF9800);
    }
  }
  Color get bg {
    switch (this) {
      case UserRole.student:  return const Color(0xFFE3F2FD);
      case UserRole.lecturer: return const Color(0xFFFFEEF2);
      case UserRole.dean:     return const Color(0xFFF3E5F5);
      case UserRole.admin:    return const Color(0xFFFFF3E0);
    }
  }
}
...
extension UserStatusExt on UserStatus {
  ...
  Color get color {
    switch (this) {
      case UserStatus.active:    return const Color(0xFF4CAF50);
      case UserStatus.inactive:  return const Color(0xFF888888);
      case UserStatus.suspended: return const Color(0xFF9B1B42);
    }
  }
  Color get bg {
    switch (this) {
      case UserStatus.active:    return const Color(0xFFE8F5E9);
      case UserStatus.inactive:  return const Color(0xFFF5F5F5);
      case UserStatus.suspended: return const Color(0xFFFFEEF2);
    }
  }
}
...
extension TimetableDayExt on TimetableDay {
  String get label {
    switch (this) {
      case TimetableDay.mon: return 'Mon';
      case TimetableDay.tue: return 'Tue';
      case TimetableDay.wed: return 'Wed';
      case TimetableDay.thu: return 'Thu';
      case TimetableDay.fri: return 'Fri';
      case TimetableDay.sat: return 'Sat';
    }
  }
}
...
class ManagedUserModel {
  ...
  final String?    indexNumber;   // students only
  final String?    staffId;       // lecturers only
  final String?    programme;     // students only
  final String?    level;         // students only
