...
class _ProfileScreenState extends State<ProfileScreen> {
                        ...
                        : () async {
                            ...
                            if (current.isEmpty ||
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                _errorSnack('Please fill in all fields.'),
                              );
                              return;
                            }
                            if (newPw.length < 8) {
                            ...
                            if (newPw != confirm) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                _errorSnack('New passwords do not match.'),
                              );
                              return;
                            }
  ...
  SnackBar _errorSnack(String message) => SnackBar(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.poppins(
                fontSize: 11,
                color: p.attendanceRate >= 75 ? _kGreen : _kCherry,
    ...
    child: Column(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: onRetry,
          child: Text('Retry', style: GoogleFonts.poppins(color: _kWhite)),
        ),
      ],
    ),
  );
